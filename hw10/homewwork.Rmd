...
```{r}
mean(Depth)-2.33*sd(Depth)/sqrt(length(Depth))
```
...
$$
\left(513.32-1.711*\frac{262.23}{\sqrt{25}},513.32+1.711*\frac{262.23}{\sqrt{25}}\right) = (513.32-79,513.32+79) = (433.37,592.70)
$$
